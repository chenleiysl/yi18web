...
<script type="text/javascript">  
 ...
 <table id="tg"></table>  
        ...
        $(function(){  
            $('#tg').treegrid({  
               ...
               // rownumbers: true,  
                ...
                collapsible:true,  
                fitColumns:true,  
               	 url:'${basePath}admin/jsondrugclass', 
    ...
    <div id="w" class="easyui-window" title="添加药品分类" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:200px;padding:10px;">  
      
        <div style="padding:10px 0 10px 60px">  
        <form id="ff" method="post" action="${basePath}admin/drugclass">  
    ...
    <div id="w2" class="easyui-window" title="编辑药品分类" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:200px;padding:10px;">  
      
        <div style="padding:10px 0 10px 60px">  
        <form id="ee" method="post" action="${basePath}admin/drugclass">
        <input type="hidden" name="id" value="0">  
            <table>  
                <tr>  
                    <td>名称:</td>  
