<#include "adminheader.ftl">
 ...
 <table class="easyui-datagrid" style="width:970px;height:auto" title="病状目录信息"  data-options="toolbar:toolbar">  
        <thead>  
            <tr>  
    ...
    <div id="w" class="easyui-window" title="添加病状目录信息" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:300px;padding:10px;">  
    ...
    <!-- 修改信息 -->
     <div id="w2" class="easyui-window" title="修改病状目录信息" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:300px;padding:10px;">  
