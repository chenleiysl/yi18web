<#include "adminheader.ftl">
 ...
 <table class="easyui-datagrid" style="width:970px;height:auto" title="疾病身体部位信息"  data-options="toolbar:toolbar">  
        <thead>  
            <tr>  
           	 
                <th data-options="field:'title'" width="100px">身体部位标题</th>  
                <!--
    ...
    <div id="w" class="easyui-window" title="添加疾病身体部位信息" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:300px;padding:10px;">  
      
        <div style="padding:10px 0 10px 60px">  
        <form id="ff" method="post" action="${basePath}admin/place"> 
    ...
    <!-- 修改信息 -->
     <div id="w2" class="easyui-window" title="修改疾病身体部位信息" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:300px;padding:10px;">  
      
        <div style="padding:10px 0 10px 60px">  
        <form id="ee" method="post" action="${basePath}admin/place"> 
        	<input type="hidden" name="id" value="0">
            <table>  
                <tr>  
                    <td>身体部位名称:</td>  
