<#include "adminheader.ftl">
 ...
 <table class="easyui-datagrid" style="width:970px;height:auto" title="疾病健康知识信息"  data-options="toolbar:toolbar">  
        <thead>  
            <tr>  
           	 
                <th data-options="field:'title'" width="100px">健康知识标题</th>  
                <!--
    ...
    <div id="w" class="easyui-window" title="添加疾病健康知识信息" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:300px;padding:10px;">  
      
        <div style="padding:10px 0 10px 60px">  
        <form id="ff" method="post" action="${basePath}admin/loreclass"> 
    ...
    <!-- 修改信息 -->
     <div id="w2" class="easyui-window" title="修改疾病健康知识信息" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:300px;padding:10px;">  
      
        <div style="padding:10px 0 10px 60px">  
        <form id="ee" method="post" action="${basePath}admin/loreclass"> 
        	<input type="hidden" name="id" value="0">
            <table>  
                <tr>  
                    <td>健康知识名称:</td>  
