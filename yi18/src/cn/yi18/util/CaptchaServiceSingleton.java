...
public class CaptchaServiceSingleton extends ListImageCaptchaEngine {    
    ...
    private static final Integer IMAGE_WIDTH = new Integer(60);       //图片的长度
   
    private static final Integer IMAGE_HEIGHT = new Integer(20);     //图片的高度
   
    private static final Integer MIN_FONT_SIZE = new Integer(14);     //最小字的大小
   
    private static final Integer MAX_FONT_SIZE = new Integer(14);    //最大字的大小
