...
public class DBManager 
{
	 ...
	 * @param show_sql 
	 */
	private final static void initDataSource(String propertiesfile) 
	{
		...
		try {
			...
			if (propertiesfile==null) {
				dbProperties = new PropertiesConfiguration("jdbc.properties");	//那么这个文件会自动在下面几个地方被搜寻：当前目录 、用户主目录 、classpath
			}else {
